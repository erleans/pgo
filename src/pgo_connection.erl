...
handle_event(info, {Tag, Socket, Binary}, Data=#data{conn=Conn=#conn{socket=Socket}}) when Tag =:= tcp orelse Tag =:= ssl ->
    Conn = pgo_handler:process_active_data(Binary, Conn),
